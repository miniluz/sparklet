...
#show: TFC.with(
  ...
  resumen: [
    ...
    condensadores que usaban los sintetizadores analógicos.
    ...
    El resultado es un sistema que contribuye tanto a la democratización de la síntesis _do it yourself_ como al estado
    del arte en algoritmos de síntesis musical para sistemas con recursos computacionales limitados. El uso de pruebas
    automáticas, el soporte de múltiples microcontroladores, y la documentación de su uso, instalación, desarrollo y
    extensión hacen que resalte frente a las alternativas.
  ],
  palabras-clave: (
    "síntesis de audio",
    "síntesis musical",
  ...
  abstract: [
    ...
    circuits found in analogue synthesizers.
    ...
    The result is a system that contributes both to the democratizacion of do-it-yourself synthesis and to the state of
    the art in musical synthesis algorithms for computationally constrained platforms. Automated testing, support for
    multiple microcontrollers, and thorough documentation covering usage, installation, development and extension set it

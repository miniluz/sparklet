...
fn main() {
    ...
    for filter in bands.iter() {
        let f64_coeffs = get_equalizer_coefficients(filter);
...
fn get_equalizer_coefficients(filter: &FilterType) -> [f64; 5] {
...
pub const EQUALIZER_POST_SHIFT: i8 = {};
...
pub static EQUALIZER_COEFFS: [[Q15; 6]; {}] = [
{}];
",
